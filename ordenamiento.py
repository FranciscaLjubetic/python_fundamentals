...
for personaje in personajes:
    nstr = personaje['name']+'has'+ personaje['eye_color']+'eyes'
    list.append(nstr)
#con lambda
nomojos=list(map(lambda x: f"{personaje['name']}+'has'+ {personaje['eye_color']}+'eyes'", personajes))
print(nomojos)

chile= personajes['heigth'].sort()
print (chile)
